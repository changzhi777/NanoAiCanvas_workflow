...
import { Nano2Header } from '@/components/Nano2Header'
...
export default function Nano2Page() {
  ...
  useEffect(() => {
    ...
    window.addEventListener('history:previewImage', handlePreviewImage as EventListener)
    return () => {
      window.removeEventListener('history:previewImage', handlePreviewImage as EventListener)
    }
  }, [])
  ...
  return (
    <div className="flex flex-col h-screen">
      <Nano2Header onSwitchToAssets={() => setRightPanelTab('assets')} />
      <Nano2ErrorBanner />

 ...
 * NanoBanana2 图片生成适配器
 */
export class NanoBanana2Adapter implements ImageGeneratorAdapter {
  readonly modelId = 'nano-banana2' as const
  readonly displayName = 'Nano Banana2'
  readonly description = '多图融合'
...
// 单例实例
let instance: NanoBanana2Adapter | null = null

export function getNanoBanana2Adapter(): NanoBanana2Adapter {
  if (!instance) {
    instance = new NanoBanana2Adapter()
  }
  return instance
}

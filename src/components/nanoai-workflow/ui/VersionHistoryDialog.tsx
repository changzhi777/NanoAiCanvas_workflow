...
import { History, RotateCcw, Trash2, Clock, GitBranch, Zap, Manual } from 'lucide-react';
                    ...
                    <div className={cn(
                      ...
                      <div className="flex items-center gap-2">
                        {!isLatest && (
                          ...
                          >
                            <RotateDcwIcon className="w-3 h-3 mr-1" />
                            恢复此版本
                          </Button>
                        )}
                        <Button
...
function RotateDcwIcon(props: React.SVGProps<SVGSVGElement>) {
  return (

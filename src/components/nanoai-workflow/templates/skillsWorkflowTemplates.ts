...
export const skillsUiMockupsWorkflow = createSkillsWorkflow(
  ...
  'custom',
  ['UI', '界面', '直播', '社交', '电商'],
  { dataId: 'node-skills-ui-data', taskId: 'node-skills-ui-task', previewId: 'node-skills-ui-preview' }
)
...
export const skillsProductVisualsWorkflow = createSkillsWorkflow(
  ...
  'custom',
  ['产品', '电商', '爆炸图', '白底'],
  { dataId: 'node-skills-product-data', taskId: 'node-skills-product-task', previewId: 'node-skills-product-preview' }
)
...
export const skillsMapsWorkflow = createSkillsWorkflow(
  ...
  'custom',
  ['地图', '美食', '旅行', '路线'],
  { dataId: 'node-skills-maps-data', taskId: 'node-skills-maps-task', previewId: 'node-skills-maps-preview' }
)
...
export const skillsSlidesWorkflow = createSkillsWorkflow(
  ...
  'custom',
  ['幻灯片', 'PPT', '汇报', '政策'],
  { dataId: 'node-skills-slides-data', taskId: 'node-skills-slides-task', previewId: 'node-skills-slides-preview' }
)
...
export const skillsPosterWorkflow = createSkillsWorkflow(
  ...
  'custom',
  ['海报', '品牌', '宣传', 'KV'],
  { dataId: 'node-skills-poster-data', taskId: 'node-skills-poster-task', previewId: 'node-skills-poster-preview' }
)
...
export const skillsPortraitsWorkflow = createSkillsWorkflow(
  ...
  'custom',
  ['肖像', '人物', '角色', '设定'],
  { dataId: 'node-skills-portraits-data', taskId: 'node-skills-portraits-task', previewId: 'node-skills-portraits-preview' }
)
...
export const skillsScenesWorkflow = createSkillsWorkflow(
  ...
  'custom',
  ['场景', '插画', '治愈', '绘本'],
  { dataId: 'node-skills-scenes-data', taskId: 'node-skills-scenes-task', previewId: 'node-skills-scenes-preview' }
)
...
export const skillsEditingWorkflow = createSkillsWorkflow(
  ...
  'custom',
  ['编辑', '修图', '背景替换', '精修'],
  { dataId: 'node-skills-editing-data', taskId: 'node-skills-editing-task', previewId: 'node-skills-editing-preview' }
)
...
export const skillsAvatarsWorkflow = createSkillsWorkflow(
  ...
  'custom',
  ['头像', '人设', '风格迁移', '贴纸'],
  { dataId: 'node-skills-avatars-data', taskId: 'node-skills-avatars-task', previewId: 'node-skills-avatars-preview' }
)
...
export const skillsStoryboardsWorkflow = createSkillsWorkflow(
  ...
  'custom',
  ['故事板', '分镜', '漫画', '电影'],
  { dataId: 'node-skills-storyboards-data', taskId: 'node-skills-storyboards-task', previewId: 'node-skills-storyboards-preview' }
)
...
export const skillsGridsWorkflow = createSkillsWorkflow(
  ...
  { dataId: 'node-skills-grids-data', taskId: 'node-skills-grids-task', previewId: 'node-skills-grids-preview' }
)
...
export const skillsBrandingWorkflow = createSkillsWorkflow(
  ...
  'custom',
  ['品牌', '包装', '吉祥物', '识别'],
  { dataId: 'node-skills-branding-data', taskId: 'node-skills-branding-task', previewId: 'node-skills-branding-preview' }
)
...
export const skillsTypographyWorkflow = createSkillsWorkflow(
  ...
  'custom',
  ['字体', '排版', '海报', '双语'],
  { dataId: 'node-skills-typography-data', taskId: 'node-skills-typography-task', previewId: 'node-skills-typography-preview' }
)
...
export const skillsAssetsWorkflow = createSkillsWorkflow(
  ...
  'custom',
  ['素材', '道具', '图标', '游戏'],
  { dataId: 'node-skills-assets-data', taskId: 'node-skills-assets-task', previewId: 'node-skills-assets-preview' }
)
...
export const skillsAcademicWorkflow = createSkillsWorkflow(
  ...
  'custom',
  ['学术', '论文', '图表', '架构'],
  { dataId: 'node-skills-academic-data', taskId: 'node-skills-academic-task', previewId: 'node-skills-academic-preview' }
)
...
export const skillsInfographicsWorkflow = createSkillsWorkflow(
  ...
  'custom',
  ['信息图', '科普', '手绘', 'KPI'],
  { dataId: 'node-skills-infographics-data', taskId: 'node-skills-infographics-task', previewId: 'node-skills-infographics-preview' }
)
...
export const skillsTechnicalWorkflow = createSkillsWorkflow(
  ...
  'custom',
  ['技术', '架构', '流程图', '系统图'],
  { dataId: 'node-skills-technical-data', taskId: 'node-skills-technical-task', previewId: 'node-skills-technical-preview' }
)
...
export const skillsCompleteWorkflow = createSkillsWorkflow(
  ...
  'custom',
  ['完整', '通用', 'Skills'],
  { dataId: 'node-skills-complete-data', taskId: 'node-skills-complete-task', previewId: 'node-skills-complete-preview' }
)

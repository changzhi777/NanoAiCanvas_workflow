...
class AgentSession(Base):
    ...
    pipeline_type = Column(String(30), default=PipelineType.ADAPTATION.value, nullable=False)
...
class AgentTask(Base):
    ...
    status = Column(String(20), default=TaskStatus.QUEUED.value, nullable=False, index=True)
...
class SystemSkill(Base):
    ...
    status = Column(String(20), default=SkillStatus.DRAFT.value, nullable=False, index=True)
...
class UserSkill(Base):
    ...
    skill_md = Column(Text, nullable=False)
    config_json = Column(JSONB, default=dict)
    status = Column(String(20), default=UserSkillStatus.PERSONAL.value, nullable=False, index=True)
...
class SkillPromotionRequest(Base):
    ...
    system_skill_id = Column(UUID(as_uuid=True), ForeignKey("system_skills.id", ondelete="SET NULL"), nullable=True)
    status = Column(String(20), default=PromotionStatus.PENDING.value, nullable=False, index=True)

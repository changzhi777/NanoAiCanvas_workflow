...
graph TD
    ...
    click L "./src/components/nanoai-workflow/CLAUDE.md" "查看 Workflow 模块文档"
    click M "./src/components/canvas/CLAUDE.md" "查看 Canvas 模块文档"
    click N "./src/components/panels/CLAUDE.md" "查看 Panels 模块文档"
    click E "./src/store/CLAUDE.md" "查看 Redux Store 模块文档"
    click D "./src/stores/CLAUDE.md" "查看 Zustand Stores 模块文档"

 ...
 *
 * 功能：4步骤向导式故事板生成界面
 * - 步骤1：脚本生成（Step1Script）
 * - 步骤2：分镜头创建（Step2Storyboard）
 * - 步骤3：对白编辑（Step3Dialogue）
 * - 步骤4：角色设计（Step4Character）
 *
 * 核心特性：
 * - 步骤间导航（上一步/下一步）
 * - 步骤完成状态验证
 ...
 * 样式主题：紫粉渐变（from-purple-400 to-pink-400）
 */
...
import type { WizardStep } from '@/stores/storyboardWizardStore'
